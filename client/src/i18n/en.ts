...
export const en = {
  ...
  'agents.inactive.bodySiblings':
    'This skill directory also has {names} in the active set (display / sorting only); there is no auto-sync here — apply / sync changes manually.',
  'agents.inactive.bodyAlone':
    'There is no auto-sync here: vault / preset changes need a manual "Apply / Sync"; your actions on this page land immediately.',
  ...
  'agents.section.control.note': 'Changes apply immediately; vault / preset changes no longer auto-sync — apply them manually',
  'agents.preset.section': 'Linked preset',
  'agents.preset.badge.title': 'Skills deployed into this directory by the linked preset',
  'agents.preset.fieldHint': 'After selecting, deploy in this panel by pressing "Apply preset"',
  'agents.preset.none': 'No preset',
  'agents.preset.hint':
    'Pick a preset and press "Apply preset" to deploy the skills configured in it into this directory once (no further auto-sync).',
  ...
  'agents.preset.apply': 'Apply preset',
  'agents.preset.apply.title':
    'Deploy the skills configured in this preset into this directory once (add-only; no further auto-sync)',
  'agents.direct.section': 'Add from the vault',
  'agents.direct.badge.title': 'Skills added directly (not via a preset)',
  'agents.direct.hint':
    'Deploy a skill into this directory from the vault in one click (no switch; deploy = done). Skills marked "From preset" come from the linked preset.',
  'agents.direct.add.title': 'Deploy (link / copy) this skill into this directory',
  'agents.direct.added': 'Added',
  'agents.direct.added.title': 'This skill is already in the directory',
  ...
  'agents.legend.skill.intro':
    'Press "Add" to deploy the skill into this directory; the badges describe where it came from and how it is stored.',
